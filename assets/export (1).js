      ...
      function drawRectOverlayOnPageCanvas(pageCanvas, img, rectPt, pageWidthPt) {
        ...
        const dx = rectPt.x * pxPerPt;
        const dy = rectPt.y * pxPerPt;
        const dw = rectPt.w * pxPerPt;
        const dh = rectPt.h * pxPerPt;
        console.log("[qibla-pdf] رسم الشعار:", {
          pageCanvasSize: [pageCanvas.width, pageCanvas.height],
          pxPerPt,
          imgNaturalSize: [img.naturalWidth, img.naturalHeight],
      ...
      function drawRotatedStampOnPageCanvas(pageCanvas, stampImg, pageWidthPt) {
        ...
        console.log("[qibla-pdf] رسم الختم:", {
          pageCanvasSize: [pageCanvas.width, pageCanvas.height],
          pxPerPt,
          imgNaturalSize: [stampImg.naturalWidth, stampImg.naturalHeight],
          imgComplete: stampImg.complete,
          center: [cx, cy],
          size: [w, h],
        });
        ctx.save();
